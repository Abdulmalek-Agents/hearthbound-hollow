inline float3 ApplyAttractionZone(float3 windVector, ZephyrWindZoneData zone, float3 position, float influenceSq)
{
    ...
    return windVector + dirToCenter * pulse * influenceSq;
}