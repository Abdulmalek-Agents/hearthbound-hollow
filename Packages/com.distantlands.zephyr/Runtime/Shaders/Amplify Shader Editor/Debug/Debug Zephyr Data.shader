	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float localGetWindComponentsAtPoint2_g1 = ( 0.0 );
				float3 position2_g1 = PositionWS;
				float3 windVector2_g1 = float3( 0,0,0 );
				float3 baseWind2_g1 = float3( 0,0,0 );
				float3 gust2_g1 = float3( 0,0,0 );
				float3 flutter2_g1 = float3( 0,0,0 );
				float3 windzones2_g1 = float3( 0,0,0 );
				{
				    windVector2_g1 = float3(0, 0, 0);
				    baseWind2_g1 = float3(0, 0, 0);
				    gust2_g1 = float3(0, 0, 0);
				    flutter2_g1 = float3(0, 0, 0);
				    windzones2_g1 = float3(0, 0, 0);
				    #ifdef ZEPHYR
				    GetWindComponentsAtPoint(position2_g1, windVector2_g1, baseWind2_g1, gust2_g1, flutter2_g1, windzones2_g1);
				    #endif
				}
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = windVector2_g1;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19903
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;14;-576,32;Inherit;False;Zephyr Wind;-1;;1;21435c2c77e48954cb9b738aae7e7fcf;0;1;1;FLOAT3;0,0,0;False;5;FLOAT3;0;FLOAT3;3;FLOAT3;4;FLOAT3;5;FLOAT3;6
