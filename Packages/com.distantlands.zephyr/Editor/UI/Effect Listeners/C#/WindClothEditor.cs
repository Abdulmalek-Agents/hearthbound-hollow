...
namespace DistantLands.Zephyr.EditorScripts
{
    ...
    [CustomEditor(typeof(WindCloth))]
    public class WindClothEditor : Editor
    {
        VisualElement root;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            VisualTreeAsset asset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                "Packages/com.distantlands.zephyr/Editor/UI/Effect Listeners/UXML/wind-cloth-editor.uxml"
            );
