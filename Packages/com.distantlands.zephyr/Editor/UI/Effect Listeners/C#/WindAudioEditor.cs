...
namespace DistantLands.Zephyr.EditorScripts
{
    ...
    [CustomEditor(typeof(WindAudio))]
    public class WindAudioEditor : Editor
    {
        VisualElement root;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            VisualTreeAsset asset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                "Packages/com.distantlands.zephyr/Editor/UI/Effect Listeners/UXML/wind-audio-editor.uxml"
            );
