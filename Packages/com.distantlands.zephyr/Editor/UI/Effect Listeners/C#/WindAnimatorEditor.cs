...
namespace DistantLands.Zephyr.EditorScripts
{
    ...
    [CustomEditor(typeof(WindAnimator))]
    public class WindAnimatorEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            VisualTreeAsset asset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                "Packages/com.distantlands.zephyr/Editor/UI/Effect Listeners/UXML/wind-animator-editor.uxml"
            );
