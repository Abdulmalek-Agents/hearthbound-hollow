...
namespace DistantLands.Zephyr.EditorScripts
{
    ...
    [CustomEditor(typeof(WindParticles))]
    public class WindParticlesEditor : Editor
    {
        VisualElement root;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            VisualTreeAsset asset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                "Packages/com.distantlands.zephyr/Editor/UI/Effect Listeners/UXML/wind-particles-editor.uxml"
            );
