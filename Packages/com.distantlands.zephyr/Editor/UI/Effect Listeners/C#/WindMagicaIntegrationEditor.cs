...
namespace DistantLands.Zephyr.EditorScripts
{
    ...
    [CustomEditor(typeof(ZephyrMagicaIntegration))]
    public class ZephyrMagicaIntegrationEditor : Editor
    {
        VisualElement root;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            VisualTreeAsset asset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                "Packages/com.distantlands.zephyr/Editor/UI/Effect Listeners/UXML/magica-integration-editor.uxml"
            );
