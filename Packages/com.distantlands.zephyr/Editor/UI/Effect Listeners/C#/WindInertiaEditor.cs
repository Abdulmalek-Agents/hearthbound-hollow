...
namespace DistantLands.Zephyr.EditorScripts
{
    ...
    [CustomEditor(typeof(WindInertia))]
    public class WindInertiaEditor : Editor
    {
        VisualElement root;
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            VisualTreeAsset asset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                "Packages/com.distantlands.zephyr/Editor/UI/Effect Listeners/UXML/wind-inertia-editor.uxml"
            );
