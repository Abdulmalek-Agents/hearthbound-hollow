...
// Hearthbound Hollow — Editor / Phase47_GuideLightsAndWayfinding
//
// Phase 47.7 — Onboarding wayfinding via a chain of subtle guide-glow
// "firefly" particles + the LaneGuidePulse'd lanterns (already authored
// by Phase 47.2). This builder adds the firefly layer on top of those:
...
//
// USE: Menu → Hearthbound → ⚙️ Advanced → ✨ Phase 47.7 — Guide Lights + Wayfinding
...
{
    public static class Phase47_GuideLightsAndWayfinding
    {
        ...
        private const string EnvParentName = "_Phase47Env_Guide";

        [MenuItem("Hearthbound/⚙️ Advanced/✨ Phase 47.7 — Guide Lights + Wayfinding", priority = 477)]
        public static void Build()
        {
            ...
            EditorUtility.DisplayDialog("Phase 47.7 — Wayfinding",
