...
// Hearthbound Hollow — Editor / Phase46_ColliderHardening
//
// Phase 46.6 — Walk every gameplay scene and ensure every visible cottage /
...
//     - Skip objects under Phase 46's invisible-blocker parents (they
...
//
// USE: Menu → Hearthbound → ⚙️ Advanced → 🛡️ Phase 46.6 — Collider Hardening
...
{
    public static class Phase46_ColliderHardening
    {
        ...
        [MenuItem("Hearthbound/⚙️ Advanced/🛡️ Phase 46.6 — Collider Hardening", priority = 466)]
        public static void Build()
        {
            ...
            foreach (var path in Scenes)
            {
                ...
                {
                    Debug.LogWarning($"[Hearthbound/Phase 46.6] Scene missing: {path}");
                    continue;
                }
                ...
                Debug.Log($"[Hearthbound/Phase 46.6] {path}  scanned={scanned}, hardened={hardened}");
            }

            EditorUtility.DisplayDialog("Phase 46.6 — Collider Hardening",
