...
// Hearthbound Hollow — Editor / Phase46_AutumnSkyboxAndLighting
//
// Phase 46.1 — Autumn-evening procedural skybox + sun + ambient lighting.
//
...
//
// USE: Menu → Hearthbound → ⚙️ Advanced → 🌇 Phase 46.1 — Autumn Skybox + Lighting
//
// Architecture notes:
...
{
    public static class Phase46_AutumnSkyboxAndLighting
    {
        ...
        [MenuItem("Hearthbound/⚙️ Advanced/🌇 Phase 46.1 — Autumn Skybox + Lighting", priority = 461)]
        public static void Build()
        {
            ...
            foreach (var cfg in SceneSunConfig)
            {
                ...
                {
                    Debug.LogWarning($"[Hearthbound/Phase 46.1] Scene not found: {cfg.scene} — skipping.");
                    continue;
                }
                sceneCount++;
            ...
            EditorUtility.DisplayDialog("Phase 46.1 — Skybox + Lighting",
        ...
        private static Material BuildOrLoadSkyMaterial()
        {
            ...
            if (shader == null)
            {
                Debug.LogError("[Hearthbound/Phase 46.1] 'Skybox/Procedural' shader not found in project. " +
        ...
        private static bool ApplyToScene(string scenePath, Material sky, float pitch, float yaw, float intensity, Color sunColor, string label)
        {
            ...
            if (sun == null)
            {
                ...
                Debug.Log($"[Hearthbound/Phase 46.1] Created Directional Light in {scene.name}.");
            }
            ...
            Debug.Log($"[Hearthbound/Phase 46.1] ✓ {label}");
