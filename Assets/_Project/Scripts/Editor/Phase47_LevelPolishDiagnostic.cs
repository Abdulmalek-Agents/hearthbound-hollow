...
// Hearthbound Hollow — Editor / Phase47_LevelPolishDiagnostic
//
// Phase 47.8 — Read-only audit of Phase 47's outputs.
//
// Per-scene checks:
//   ✓ Skybox material assigned (RenderSettings.skybox != default)
//   ✓ Sun directional light bound (RenderSettings.sun != null)
//   ✓ Phase 47 environment parent present
...
//
// USE: Menu → Hearthbound → ⚙️ Advanced → 🔍 Phase 47.8 — Diagnose Level Polish
//
...
{
    public static class Phase47_LevelPolishDiagnostic
    {
        [MenuItem("Hearthbound/⚙️ Advanced/🔍 Phase 47.8 — Diagnose Level Polish", priority = 478)]
        public static void Diagnose()
        {
            var report = RunDiagnostics();
            EditorUtility.DisplayDialog("Phase 47.8 — Level Polish Audit",
                report,
                "OK");
        }
        ...
        public static string RunDiagnostics()
        {
            ...
            sb.AppendLine("Phase 47 — Level Polish Audit");
            sb.AppendLine("==============================");

            CheckScene(sb, "Assets/_Project/Scenes/02_Mission01_Lane.unity",
                env: "_Phase47Env_Lane",
            ...
            bool expectPerimeter, bool expectGuideLanterns, bool expectHearthFlicker)
        {
            ...
            sb.AppendLine(envObj != null
                ...
                : $"  ✗ {env} missing  — re-run Phase 47 capstone");
