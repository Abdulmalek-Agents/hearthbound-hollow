...
{
    public class BindableH3 : Label, IBindable
    {
        public new class UxmlFactory : UxmlFactory<BindableH3, BindableH3.UxmlTraits>
        {
            internal const string ElementName = "BindableH3";
            ...
            public override string uxmlQualifiedName
            {
                get
                {
                    return "UnityEditor.UIElements.BindableH3";
                }
            }
        }
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                try
                {
                    BindableH3 bindableH;
                    if ((bindableH = (ve as BindableH3)) != null)
                    {
        ...
        public BindableH3() : this(null, string.Empty)
        {
        }
        public BindableH3(SerializedProperty property) : this(property, string.Empty)
        {
        }
        public BindableH3(SerializedProperty property, string label)
        {
            base.RemoveFromClassList(BindableH3.labelUssClassName);
            base.AddToClassList(BindableH3.ussClassName);
            base.AddToClassList(BindableH3.headlineClassName);
        ...
        protected override void ExecuteDefaultActionAtTarget(EventBase evt)
        {
            ...
            if (!SystemExtensions.IsNullOrEmpty(this.bindingPath))
            {
                ...
                {
                    if (BindableH3.bindObject == null)
                    {
                        BindableH3.bindObject = type.GetProperty("bindObject");
                    }
                    SerializedObject serializedObject = BindableH3.bindObject.GetValue(evt) as SerializedObject;
                ...
                else
                {
                    ...
                    {
                        if (BindableH3.bindProperty == null)
                        {
                            BindableH3.bindProperty = type.GetProperty("bindProperty");
                        }
                        this._serializedProperty = (BindableH3.bindProperty.GetValue(evt) as SerializedProperty);
                        if (this._serializedProperty != null)
                        {
                            this.CreateView();
                        }
