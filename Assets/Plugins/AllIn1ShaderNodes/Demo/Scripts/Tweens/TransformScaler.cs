...
namespace AllIn1ShaderNodes
{
	public class TransformScaler : MonoBehaviour
	{
		...
		public void Init(float scaleDuration, AnimationCurve scaleCurve)
		{
			Init(scaleDuration, scaleCurve);
		}

		public void Init(float scaleDuration, AnimationCurve scaleCurve, Action<ScalingType> scaleFinishedCallback)
		{
