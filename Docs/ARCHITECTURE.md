...
*Document version 1.8 — Phase 47 One More Day (D-064) + Phase 46.2 voice sanitiser (D-064b) + Phase 53 Polish Menu Layer: localization (D-065) + character creation (D-066).*
